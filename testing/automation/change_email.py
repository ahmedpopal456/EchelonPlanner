...
class ChangeEmail(unittest.TestCase):
    ...
    def test_change_email(self):
        ...
        driver.find_element_by_link_text("Change Email").click()
        driver.find_element_by_id("inputNewEmail").clear()
        driver.find_element_by_id("inputNewEmail").send_keys("bob@concordia.ca")
        driver.find_element_by_id("verifyNewEmail").clear()
        driver.find_element_by_id("verifyNewEmail").send_keys("bob@concordia.ca")
        driver.find_element_by_xpath("//button[@type='submit']").click()
